# =========================================================
# Holt-Winters CO2 Forecasting with 80% & 95% Prediction Intervals
# =========================================================
...
for i, country in enumerate(countries):
    ...
    # ---------------------------
    residuals = train['CO2'] - model.fittedvalues
    ...
    for _ in range(n_bootstrap):
        ...
        boot_preds_test.append(y_pred.values + sampled_residuals)
    ...
    # Future Forecast
    # ---------------------------
    y_future = model.forecast(n_future)
    ...
    for _ in range(n_bootstrap):
        ...
        boot_preds_future.append(y_future.values + noise)
    ...
    forecast_df = pd.DataFrame(
        {
            'Year': future_years,
            'Point Forecast': y_future.values,
...
plt.title("Holt-Winters CO₂ Forecasting with 80% & 95% Prediction Intervals")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
